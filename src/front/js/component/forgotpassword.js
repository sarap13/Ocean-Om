...
export const ForgotPassword = () => {
    ...
    return (
            <div className="min-vh-100 h-100 container-fluid stylebackgrounding d-flex col-12 col-sm-12 col-md-6 col-lg-6 mb-5 ms-3 flex-column justify-content-center align-items-center text-secondary pt-5 mt-3">
